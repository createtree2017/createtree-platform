        ...
        <Link href="/" className="flex items-center">
          {collapsed ? (
            <div className="w-8 h-8 rounded-full bg-primary-lavender/20 flex items-center justify-center">
              <span className="text-primary-lavender font-bold">AI</span>
            </div>
          ) : (
            <img 
              src="/logo.svg" 
