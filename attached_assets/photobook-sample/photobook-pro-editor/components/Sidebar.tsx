...
import { Upload, Image as ImageIcon, Layout, X, Check } from 'lucide-react';
...
export const Sidebar: React.FC<SidebarProps> = ({ 
  ...
  const [activeTab, setActiveTab] = React.useState<'photos' | 'layouts'>('photos');
      ...
      <div className="flex-1 overflow-y-auto p-4 bg-gray-50">
        {activeTab === 'photos' && (
          <div className="space-y-4">
            <div 
              ...
              className="border-2 border-dashed border-gray-300 rounded-lg p-6 flex flex-col items-center justify-center text-gray-500 cursor-pointer hover:border-indigo-400 hover:bg-indigo-50 transition-colors"
            >
              ...
              {assets.map((asset) => {
                ...
                return (
                  ...
                  >
                    ...
                    {/* Delete Button - Only shown if not used */}
                    {!isUsed && (
                      <button
                        type="button"
                        onMouseDown={(e) => e.stopPropagation()} 
                        onPointerDown={(e) => e.stopPropagation()} // Added for robust event handling
                        onClick={(e) => {
                          e.stopPropagation();
                          e.preventDefault();
        ...
        {activeTab === 'layouts' && (
          <div className="text-center text-gray-500 py-10">
            ...
            <p className="text-xs mt-2">(Not implemented in this demo)</p>
          </div>
        )}
      </div>
    </div>
